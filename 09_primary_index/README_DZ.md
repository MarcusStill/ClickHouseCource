...
### Задание 1. 
Создайте таблицу user_collapsing с движком CollapsingMergeTree.
...
Приложите 5 скриптов.

### Задание 12. 
Создайте таблицу user_replacing с движком ReplacingMergeTree.
...
### 1. Создание таблицы user_collapsing с движком CollapsingMergeTree
...
### 2. Добавление пользователя с rank = 0 и active = 0
...
### 3. Изменение значения rank с 0 до 5
...
### 4. Получение актуальных данных пользователя
...
Результат
```text
user_id|active|rank|_part    |
-------+------+----+---------+
      1|     1|   5|all_2_2_1|
```

### 5. Создание таблицы user_replacing с движком ReplacingMergeTree
...
### 6. Добавление пользователя с rank = 0 и active = 0
...
### 7. Изменение значения active с 0 на 1
...
### 8. Изменение значения rank с 0 до 5
...
### 9. Получение актуальных данных пользователя
...
Результат
```text
user_id|active|rank|version|_part    |
-------+------+----+-------+---------+
      1|     1|   5|      3|all_3_3_1|
```