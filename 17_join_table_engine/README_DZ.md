...
Создайте таблицу dim_teacher с движками Join и MergeTree. Наполните их данными. Сравните производительность соединения таблицы источника и таблицы-справочника.
...
### 2. Создадим таблицу с движком Join
